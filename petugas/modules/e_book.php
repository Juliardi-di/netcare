        ...
        <li>
            <div class="ebook-card">
                ...
                <div class="ebook-actions">
                    <a href="#" class="btn-view" onclick="openPDF('/netcare/ebooks/zoom_meeting.pdf')">
                        <i class="fa fa-eye"></i> Lihat
                    </a>
                    <a href="/netcare/ebooks/zoom_meeting.pdf"
                    download
                    class="btn-download">
            ...
            <div class="ebook-card">
                ...
                <div class="ebook-actions">
                   <a href="#" class="btn-view"
                    onclick="openPDF('/netcare/ebooks/live_streaming.pdf')">
                    <i class="fa fa-eye"></i> Lihat
                    </a>

                    <a href="/netcare/ebooks/live_streaming.pdf"
                    download
                    class="btn-download">
                    <i class="fa fa-download"></i> Unduh
                    </a>
