    ...
    <div class="card-body d-flex gap-4">
        ...
        <div style="width:220px;text-align:center;">
            <div style="
                ...
                background:#d60000;
                overflow:hidden;">
                <img src="/netcare/petugas/uploads/profil/<?= htmlspecialchars($images) ?>"
...
<div class="card mb-4 shadow-sm" id="edit-profil" style="display:none;">
        ...
        <div class="card-body">
            <form method="POST" action="/netcare/petugas/modules/update_profil.php">
...
<div class="card shadow-sm" id="ganti-password" style="display:none;">
        ...
        <div class="card-body">
            <form method="POST" action="/netcare/petugas/modules/update_password.php">
...
<div class="card shadow-sm" id="ubah-foto" style="display:none;">
    ...
    <form method="POST"
      action="/netcare/petugas/modules/proses_ubah_foto.php"
