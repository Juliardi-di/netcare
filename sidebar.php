...
<aside class="sidebar">
    ...
    <ul>
        ...
        $menus = [
            ...
            'registrasi_akun'      => ['Registrasi Akun', 'fa-solid fa-user-plus'],
            'pengajuan_layanan'    => ['Verifikasi Layanan', 'fa-solid fa-circle-check'],
            'dokumentasi'          => ['Dokumentasi', 'fa-solid fa-folder-open'],
            'laporan_rekapitulasi' => ['Laporan & Rekapitulasi', 'fa-solid fa-file-lines'],
        ...
        foreach ($menus as $key => [$label, $icon]) {
            ...
            echo "
                <li>
                    <a href='dashboard.php?page=$key' class='$active'>
                        <i class='$icon'></i>
                        <span>$label</span>
                    </a>
                </li>
